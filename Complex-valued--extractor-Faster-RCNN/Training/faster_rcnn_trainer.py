...
classes = "/media/admin/Données/tf_records/data.names"
path_dataset_train = '/media/admin/Données/tf_records/rec_ref_896_int_pha_3_train.tfrecords'
train_data = dataset.load_tfrecord_dataset(path_dataset_train, classes, size)
path_dataset_val = '/media/admin/Données/tf_records/rec_ref_896_int_pha_3_validation.tfrecords'
...
frcnn_model_path = io_utils.get_model_path("faster_rcnn_complex_input_fold4", backbone)
log_path = io_utils.get_log_path("faster_rcnn_complex_input_fold4", backbone)
load_weights = False
#if load_weights:
	#frcnn_model_path0 = io_utils.get_model_path("faster_rcnn_complex_fold0", backbone)
