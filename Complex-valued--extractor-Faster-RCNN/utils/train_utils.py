...
RPN = {
    "vgg16": {
        "img_size":896,
        "img_size_vgg": (2, 896, 896, 1),        
        "feature_map_shape": 56,
        "anchor_ratios": [1., 2., 1./2.],
        "anchor_scales": [30,50,70],
    },
    # "mobilenet_v2": {
    #     "img_size":896,
    #     "img_size_vgg": (896,896,2),
    #     "feature_map_shape": 32,
    #     "anchor_ratios": [1., 2., 1./2.],
    #     "anchor_scales": [20,40,60],
    # }
}
...
def get_hyper_params(backbone, **kwargs):
    ...
    hyper_params["pre_nms_topn"] = 3000
    hyper_params["train_nms_topn"] = 1500
    hyper_params["test_nms_topn"] = 500 #non max supression
    hyper_params["nms_iou_threshold"] = 0.8
    hyper_params["total_pos_bboxes"] = 500
    hyper_params["total_neg_bboxes"] = 500
