...
path_dataset_test ='/media/admin/Données/tf_records/rec_ref_896_int_pha_3_validation.tfrecords'
...
# #
frcnn_model_path = io_utils.get_model_path("faster_rcnn_complex_int_phase_input_fold3", backbone)
...
with open('/home/admin/Documents/Dev/mcnemar/complex_fold4.txt', 'w') as fp:
    for item in list_sorty:
