...
class Decoder(Layer):
    ...
    """
    def __init__(self, variances, total_labels, max_total_size=301, score_threshold=0.5, **kwargs):
...
def get_model(feature_extractor, rpn_model, anchors, hyper_params, mode="training"):
    ...
    #
    roi_pooled = RoIPooling(hyper_params, name="roi_pooling")([feature_extractor, roi_bboxes])
    #
...
def init_model(model, hyper_params):
    ...
    inputs:
        ...
        hyper_params = dictionary
    """
    final_depth, final_height, final_width = 2 ,hyper_params["img_size"], hyper_params["img_size"]
    img = tf.random.uniform((1,final_depth, final_height, final_width, 1))
